...
if __name__ == '__main__':
    files = [
        'Story-Unending/js/ui/ab-testing-ui.js',
        'Story-Unending/js/ui/sidebar.js',
        'Story-Unending/js/ui/director-panel.js',
        'Story-Unending/js/ui/reader-panel.js',
        'Story-Unending/js/modules/initialization.js',
        'Story-Unending/js/modules/app-state.js',
        'Story-Unending/js/utils/error-handler.js'
    ]
