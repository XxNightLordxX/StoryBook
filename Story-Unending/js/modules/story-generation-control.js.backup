...
(function() {
  ...
  const updateGenerationMode = () => {
    const select = document.getElementById('generationMode');
    if (!select) {
  ...
  const togglePause = () => {
    ...
    const pauseIcon = document.getElementById('pauseIconScreen');
    const pauseLabel = document.getElementById('pauseLabelScreen');
    const pauseBtn = document.getElementById('pauseBtnScreen');
    const speedDisplay = document.getElementById('speedCurrentDisplayScreen');
  ...
  const updateSpeedDisplay = () => {
    const speedDisplay = document.getElementById('speedCurrentDisplayScreen');
    const speedValue = document.getElementById('speedValueDisplayScreen');
