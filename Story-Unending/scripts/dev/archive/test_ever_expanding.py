#!/usr/bin/env python3
"""
Test the Ever-Expanding Story System
"""
...
def test_system():
    print("="*60)
    print("Testing Ever-Expanding Story System")
    print("="*60)
...
'''
    ...
    # Write test script
    with open('scripts/test_ever_expanding.js', 'w') as f:
        f.write(test_script)
    
    # Run the test
    print("\nRunning test...")
    result = subprocess.run(
        ['node', 'scripts/test_ever_expanding.js'],
        capture_output=True,
        text=True,
        timeout=60
    )
