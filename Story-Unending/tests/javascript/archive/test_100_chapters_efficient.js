/**
 * Test 100 Chapters with Efficient Pool Expansion
 * Expands pools every 10 chapters instead of every chapter
 */
...
async function initializeSystems() {
  ...
  // Initialize integration with auto-expand disabled
  EverExpandingIntegration.initialize(StoryEngine, {
    ...
    expansionCount: TEST_CONFIG.expansionCount,
    autoExpand: false, // Disable auto-expand for efficiency
    persistData: false,
    maxPoolSize: 10000
  });
...
async function generateAndTestChapter(chapterNum) {
  ...
  if (chapterNum % TEST_CONFIG.expansionInterval === 0) {
    console.log(`  Expanding pools at chapter ${chapterNum}...`);
    await EverExpandingIntegration.triggerExpansion({
...
async function runTest() {
  console.log('\n========================================');
  console.log('Testing 100 Chapters with Efficient Expansion');
  console.log('========================================\n');
