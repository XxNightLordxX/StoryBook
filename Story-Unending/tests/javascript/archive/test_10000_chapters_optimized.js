/**
 * Test 10,000 Chapters with Optimized Pool Expansion
 * Verifies 100% uniqueness and performance with proactive duplicate detection
 */
...
const OptimizedIntegration = require('../../js/optimized-integration.js');
...
global.OptimizedIntegration = OptimizedIntegration;
...
async function initializeSystems() {
  ...
  OptimizedIntegration.initialize(StoryEngine, {
    enableWebSearch: TEST_CONFIG.enableWebSearch,
...
async function generateAndTestChapter(chapterNum) {
  ...
  // Record pool stats every 100 chapters
  if (chapterNum % 100 === 0) {
...
async function runTest() {
  console.log('\n========================================');
  console.log('Testing 10,000 Chapters with Optimized Expansion');
  console.log('========================================\n');
